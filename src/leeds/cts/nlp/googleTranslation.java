...
//	public static void main(String[] args) {
		// TODO Auto-generated method stub
         ...
         //  a.writtenFile();
         //    a.translation("LATVIAN", "ENGLISH", "/home/fzsu/tilde-LV-EN/ITLocalizationLV/TextFiles", "/home/fzsu/test-translation");
        //      a.translation("GERMAN", "ENGLISH", "/home/fzsu/ICC/RO-DE/DE-sent", "/home/fzsu/ICC/RO-DE/DE-trans");
        //    a.ArrayTranslation("LATVIAN", "ENGLISH", "/home/fzsu/tilde-LV-EN/ITLocalizationLV/TextFiles", "/home/fzsu/test-translation");
       //   a.ArrayTranslation("GERMAN", "ENGLISH", "/home/fzsu/ICC/RO-DE/sample", "/home/fzsu/ICC/RO-DE/sample-translation");
       //             a.getFilePathName();
              //        a.ArrayTranslation("RUSSIAN", "ENGLISH", "/home/fzsu/wikorpus/renewable-sent-ru", "/home/fzsu/wikorpus/renewable-translation");
      //  a.test();
      //       a.translations("GERMAN", "ENGLISH", "/home/fzsu/ICC/RO-DE/test", "/home/fzsu/ICC/RO-DE/test-translation");
         //     a.translations("GERMAN", "ENGLISH", "/home/fzsu/ICC/RO-DE/sample", "/home/fzsu/ICC/RO-DE/test-translation");
        //       a.ArrayTranslations("GERMAN", "ENGLISH", "/home/fzsu/ICC/RO-DE/test", "/home/fzsu/ICC/RO-DE/test-translation");
//	}
		 ...
		 for (int i=0;i<t.length;i++){
			...
			//	 System.out.println("PUNCTUATION in RANGE: "+t[i]);
					...
					//	System.out.println(w+" "+w.length());
						if (k+1<str.length){
						if (w.length()+str[k+1].length()>=limit){	
							chunk.add(w+" .");
...
public void test(){
	try{
		 Translate.setHttpReferrer("http://sites.google.com/site/xiaojun/");
		ArrayList alist=new ArrayList();
	...
	/*	String s="I was ill at home she is a good man But we dont like him do you can you say sth about it";
	    ...
	    System.out.println(t.length);
	     for (int i=0;i<t.length;i++){
	    	 System.out.println(t[i]+t[i].length());
	     } */
		//	chunks(alist);
	//	for (int i=0;i<alist.size();i++){
	//		System.out.println(alist.get(i).toString()+" "+alist.get(i).toString().length());
	//	}
	//	 Translate.setHttpReferrer("http://sites.google.com/site/xiaojun/");
	
		 
	/*	 BufferedReader br1=new BufferedReader(new FileReader("/home/fzsu/test-sample/lv/file_200_cleared.txt"));
		 ArrayList alist=new ArrayList();
		 String s="";
		 int length=0;
		 boolean flag=false;
	...
	//}
		/*	System.out.println(count);
		    ...
		    String[] translatedTexts = Translate.execute(array,  Language.LATVIAN, Language.ENGLISH);
	             for (int i=0;i<translatedTexts.length;i++){
	            	 System.out.println(translatedTexts[i]);
	             }   */
			
		/*	String[] array={"Tas der tikai interneta pārlūka lietošanai","Tas der tikai interneta pārlūka lietošanai"};
			String[] result=Translate.execute(array,  Language.LATVIAN, Language.ENGLISH);
	        for (int i=0;i<result.length;i++){
	...
	public void writtenFile(){
		try{
			BufferedWriter bw=new BufferedWriter(new FileWriter("/home/fzsu/ICC/RO-DE/test-translation/file.done"));
			File f=new File("/home/fzsu/ICC/RO-DE/test-translation/tranalsation");
			File[] list=f.listFiles();
	...
	public void getFilePathName() {
		  TreeMap<Long,File> tm = new TreeMap<Long,File>();
		  File file = new File("/home/fzsu/ICC/RO-DE/test-translation");
		  File subFile[] = file.listFiles();
		  int fileNum = subFile.length;
		  for (int i = 0; i < fileNum; i++) {
		   Long tempLong = new Long(subFile[i].lastModified());
